...
if !exists("hive_version") || hive_version >= 11
    ...
    sy keyword Keyword over rows current unbounded preceding following
endif
...
if !exists("hive_version") || hive_version >= 13
    ...
    sy keyword Keyword roles privileges principals
endif
...
sy keyword hiveAddKw add file files jar jars archive archives nextgroup=hiveAddKw contained skipwhite
